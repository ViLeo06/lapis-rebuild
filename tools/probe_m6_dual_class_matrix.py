...
def build(setlib_dir: Path, *, client_root: Path | None = None, client_files_csv: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "boundaries": {
            "authored_levelabl_experience_values": "VERIFIED-STATIC-ORIGINAL",
            "authored_levelabl_class_link_values": "VERIFIED-STATIC-ORIGINAL",
            "authored_levelabl_sub_magic_rows": "VERIFIED-STATIC-ORIGINAL",
            "promotion_semantics_and_conditions": "SERVER-BOUNDARY",
            "server_exp_authority_and_transition": "SERVER-BOUNDARY",
