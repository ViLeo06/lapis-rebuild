...
export type Manifest = { schema: number; provenance?: { kind: string; installer_sha256?: string; evidence: Evidence }; characters: Record<string, ActorPack>; map: { id: number; name: string; png: string; collision: string; inspector?: string; render: { width: number; height: number } } };
