...
test('S34 contract records exact integrated upstream source heads',()=>{
  ...
  assert.deepEqual(contract.upstream_handoffs.map(row=>row.status),['integrated','integrated','integrated','integrated']);
